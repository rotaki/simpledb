...
dir_entry btree_dir::insert(const dir_entry &pDE) {
  ...
  std::shared_ptr<btree_dir> child =
      std::shared_ptr<btree_dir>(new btree_dir(mTx, childBlk, mLt));
...
std::shared_ptr<block_id>
btree_dir::find_child_block(const constant &pSearchKey) {
