...
constant dir_entry::data_val() const { return mDataVal; }
int dir_entry::block_number() const { return mBlockNum; }

bool dir_entry::is_null() const { return mDataVal.is_null(); }
} // namespace simpledb
