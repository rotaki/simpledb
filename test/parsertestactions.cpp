...
TEST(parse, parsertestactions_test) {
  ...
  std::cout << "Out op: "
            << static_cast<object::operation>(p2.update_cmd()->op())
            << std::endl;
  ;
  ...
  std::cout << "Out op: "
            << static_cast<object::operation>(p3.update_cmd()->op())
            << std::endl;
  ;
  ...
  std::cout << "Out op: "
            << static_cast<object::operation>(p4.update_cmd()->op())
            << std::endl;
  ;
  ...
  std::cout << "Out op: "
            << static_cast<object::operation>(p5.update_cmd()->op())
            << std::endl;
  ;
  ...
  std::cout << "Out op: "
            << static_cast<object::operation>(p6.update_cmd()->op())
            << std::endl;
  ;
  ...
  std::cout << "Out op: "
            << static_cast<object::operation>(p7.update_cmd()->op())
            << std::endl;
  ;
}
} // namespace simpledb
