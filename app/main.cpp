...
namespace simpledb {
  ...
  void create_student_database() {
    ...
    try {
      ...
      std::vector<std::string> studVals = {"(1, 'joe', 10, 2021)",
                                           "(2, 'amy', 20, 2020)",
                                           "(3, 'max', 10, 2022)",
                                           "(4, 'sue', 20, 2022)",
                                           "(5, 'bob', 30, 2020)",
      ...
      std::vector<std::string> deptVals = {"(10, 'compsci')",
                                           "(20, 'math')",
                                           "(30, 'drama')"};
      ...
      std::vector<std::string> courseVals = {"(12, 'db systems', 10)",
                                             "(22, 'compilers', 10)",
                                             "(32, 'calculus', 20)",
                                             "(42, 'algebra', 20)",
                                             "(52, 'acting', 30)",
      ...
      std::vector<std::string> sectVals = {"(13, 12, 'turing', 2018)",
                                           "(23, 12, 'turing', 2019)",
                                           "(33, 32, 'newton', 2019)",
                                           "(43, 32, 'einstein', 2017)",
                                           "(53, 62, 'brando', 2018)"};
      ...
      std::vector<std::string> enrollVals = {"(14, 1, 13, 'A')",
                                             "(24, 1, 43, 'C' )",
                                             "(34, 2, 43, 'B+')",
                                             "(44, 4, 33, 'B' )",
                                             "(54, 4, 53, 'A' )",
