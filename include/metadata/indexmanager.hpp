...
namespace smartdb {
  ...
  public:
    ...
    index_info(const std::string &pIdxName, const std::string &pFldName, const schema &pTblSchema, transaction* pTx, const stat_info &pSI);
  ...
  public:
    index_manager(const bool &pIsNew, table_manager* pTM, stat_manager* pSM, transaction* pTx);
